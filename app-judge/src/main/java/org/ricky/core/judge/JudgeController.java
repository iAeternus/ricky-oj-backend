...
public class JudgeController {
    ...
    @PutMapping("/modify/result")
    @Operation(summary = "变更评测结果")
    public void modifyJudgeResult(@RequestBody @Valid ModifyJudgeResultCommand command,
                                  @AuthenticationPrincipal UserContext userContext) {
        judgeAlterationService.modifyJudgeResult(command, userContext);
    }
