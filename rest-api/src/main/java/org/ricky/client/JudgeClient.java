...
import org.ricky.dto.alter.response.FetchJudgeByIdResponse;
...
public interface JudgeClient {
    ...
    FetchJudgeByIdResponse fetchJudgeById(@PathVariable("judgeId") @Id(prefix = JUDGE_ID_PREFIX) String judgeId);
